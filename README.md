...
| `utopia`.           | _off_         | Enables support for using `TypedPath` in requests. See [utoipa-axum](https://crates.io/crates/utoipa-axum) for details.                                |
...
The current version of Axum Test requires at least Axum v0.8.8.
